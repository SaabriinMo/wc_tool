...
def output(args):
    result = []
    if args.c:
        result.extend([wc_tool.wc_byte_count(args.file),args.file])
    if args.l:
        result.extend([wc_tool.wc_line_count(args.file),args.file])
    if args.w:
        result.extend([wc_tool.wc_word_count(args.file),args.file])
    if args.m:
        result.extend([wc_tool.wc_char_count(args.file),args.file])
